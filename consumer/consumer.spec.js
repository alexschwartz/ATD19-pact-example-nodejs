...
describe('Component test for OrderWeb (with mocked Order API via pact)', () => {
  ...
  describe('given there no orders', () => {
    ...
    describe('when a call to the API is made', () => {
      ...
      it('will receive an empty list', () => {
        return expect(fetchOrders()).to.be.empty
      })
    })
  })
